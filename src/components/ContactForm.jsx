  ...
  const sendEmail = (e) => {
    ...
    <div className='my-7 py-3'>
      ...
      <form className='rounded-lg flex flex-col items-center  lg:max-w-[1240px] mx-auto px-4' onSubmit={sendEmail}>
        ...
        <input className='rounded-lg lg:w-[60%] w-[80%] border-2 px-2 py-1 border-green-700 bg-gray-200' required type="text" name="to_name" />
        <label>E-Mail</label>
        <input className='rounded-lg lg:w-[60%] w-[80%] border-2 px-2 py-1 border-green-700 bg-gray-200 ' required type="email" name="from_name" />
        <label>Poruka</label>
        <textarea className='rounded-lg h-[200px] lg:w-[60%] w-[90%] border-2 px-2  border-green-700 bg-gray-200' name="message" />
